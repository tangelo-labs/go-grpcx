...
func TestUnaryClientInterceptor(t *testing.T) {
	...
	ctx = metadata.NewOutgoingContext(context.Background(), metadata.Pairs(causationIDTransportKey, "test-causation-id"))
...
func TestFromContextMetadata(t *testing.T) {
	t.Run("Valid Metadata", func(t *testing.T) {
		ctx := metadata.NewIncomingContext(context.Background(), metadata.Pairs(causationIDTransportKey, "test-causation-id"))
